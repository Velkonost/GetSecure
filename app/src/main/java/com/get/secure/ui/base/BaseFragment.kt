package com.get.secure.ui.base
...
import com.get.secure.glide.GlideApp
import com.get.secure.util.ext.getViewModel
...
) : DaggerFragment(), Toolbar.OnMenuItemClickListener, FragmentResult {
