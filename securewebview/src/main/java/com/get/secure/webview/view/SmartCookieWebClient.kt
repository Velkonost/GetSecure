package com.get.secure.webview.view
...
import com.get.secure.BuildConfig
import com.get.secure.webview.AppTheme
import com.get.secure.webview.adblock.allowlist.AllowListModel
import com.get.secure.webview.constant.FILE
import com.get.secure.webview.controller.UIController
...
import com.get.secure.webview.di.DatabaseScheduler
import com.get.secure.webview.di.injector
import com.get.secure.webview.extensions.resizeAndShow
import com.get.secure.webview.extensions.snackbar
import com.get.secure.webview.js.BlockAMP
import com.get.secure.webview.js.BlockAds
import com.get.secure.webview.js.CookieBlock
import com.get.secure.webview.js.DarkMode
import com.get.secure.webview.js.InvertPage
import com.get.secure.webview.js.SetWidenViewport
import com.get.secure.webview.js.TextReflow
import com.get.secure.webview.js.Translate
import com.get.secure.webview.log.Logger
import com.get.secure.webview.preference.UserPreferences
import com.get.secure.webview.ssl.SslState
import com.get.secure.webview.ssl.SslWarningPreferences
import com.get.secure.webview.utils.IntentUtils
import com.get.secure.webview.utils.ProxyUtils
import com.get.secure.webview.utils.Utils
import com.get.secure.webview.utils.Utils.buildErrorPage
import com.get.secure.webview.utils.isSpecialUrl
            ...
            if (userPreferences.siteBlockChoice === SiteBlockChoice.WHITELIST) run {
                if (userPreferences.siteBlockNames !== "") {
                    ...
                    if (arrayOfURLs.contains(", ")) {
                        ...
                        strgs = arrayOfURLs.split("," + System.getProperty("line.separator").toString().toRegex()).dropLastWhile { it.isEmpty() }
                            .toTypedArray()
                    }  else{
                        strgs = arrayOfURLs.split(",".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()
                    }
